...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('plant_stocks', function (Blueprint $table) {
            ...
            // Relationships
            $table->foreignId('plant_specy_id')->constrained('plant_species')->restrictOnDelete()->cascadeOnUpdate();
            ...
            $table->index(['plant_specy_id', 'plant_variety_id', 'plant_sample_id', 'status']);
        });
    }
