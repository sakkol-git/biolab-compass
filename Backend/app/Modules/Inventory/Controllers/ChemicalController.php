...
class ChemicalController extends Controller
{
    ...
    public function index(Request $request): AnonymousResourceCollection
    {
        ...
        return ChemicalResource::collection($query->paginate(10));
    }
    ...
    public function store(StoreChemicalRequest $request): JsonResponse
    {
        ...
        $this->imageService->handleImageData($data, Chemical::imageFolder());
    ...
    public function update(UpdateChemicalRequest $request, Chemical $chemical): ChemicalResource
    {
        ...
        $data = $request->validated();
        $this->imageService->handleImageData($data, Chemical::imageFolder(), $chemical);
