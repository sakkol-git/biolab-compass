...
import PlantBatches from "./pages/inventory/PlantBatches";
...
import PlantBatchDetail from "./pages/inventory/PlantBatchDetail";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/inventory/plant-batches" element={<PlantBatches />} />
          <Route path="/inventory/plants" element={<Navigate to="/inventory/plant-species" replace />} />
          ...
          <Route path="/inventory/products/species/:id" element={<PlantSpeciesDetail />} />
          <Route path="/inventory/products/batches/:id" element={<PlantBatchDetail />} />
          <Route path="/inventory/products/chemicals/:id" element={<ChemicalDetail />} />
          <Route path="/inventory/products/equipment/:id" element={<EquipmentDetail />} />

          {/* Legacy route redirects */}
          <Route path="/plant-species" element={<Navigate to="/inventory/plant-species" replace />} />
          <Route path="/plant-batches" element={<Navigate to="/inventory/plant-batches" replace />} />
          <Route path="/chemicals" element={<Navigate to="/inventory/chemicals" replace />} />
          <Route path="/equipment" element={<Navigate to="/inventory/equipment" replace />} />
          <Route path="/transactions" element={<Navigate to="/inventory/transactions" replace />} />
          <Route path="/users" element={<Navigate to="/inventory/users" replace />} />
          <Route path="/products/species/:id" element={<Navigate to="/inventory/products/species/:id" replace />} />
          <Route path="/products/batches/:id" element={<Navigate to="/inventory/products/batches/:id" replace />} />
          <Route path="/products/chemicals/:id" element={<Navigate to="/inventory/products/chemicals/:id" replace />} />
          <Route path="/products/equipment/:id" element={<Navigate to="/inventory/products/equipment/:id" replace />} />
          ...
          <Route path="/business/production" element={<ProductionPlanner />} />
          <Route path="/business/clients" element={<Clients />} />
          <Route path="/business/contracts" element={<Contracts />} />
          <Route path="/business/contracts/:id" element={<ContractDetail />} />
