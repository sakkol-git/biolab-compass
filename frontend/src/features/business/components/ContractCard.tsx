...
import { Building2, Calendar, DollarSign, Sprout } from "lucide-react";
import { useNavigate } from "react-router-dom";

// ─── Internal ──────────────────────────────────────────────────────────────
import type { Contract } from "@/features/business/types";
...
const CardHeader = ({ contract }: { contract: Contract }) => (
  <div className="flex items-start justify-between mb-3">
    <div>
      ...
      <h3 className="font-medium text-foreground text-sm mt-0.5">
        {contract.clientName}
      </h3>
    </div>
    <span
