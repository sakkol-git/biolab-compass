...
import { currentUser, researchAchievementsData } from "@/data/mockUserData";
import type { ResearchAchievement } from "@/types/user";
...
const UserProfile = () => {
  ...
  const [achievements, setAchievements] = useState<ResearchAchievement[]>(
    researchAchievementsData.filter((a) => a.userId === user.id),
  );
