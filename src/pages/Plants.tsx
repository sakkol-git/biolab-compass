      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-foreground">Plant Inventory</h1>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50">
                ...
                <TableHead className="font-semibold">Growth Stage</TableHead>
            ...
            <TableBody>
              {filteredPlants.map((plant) => (
                <TableRow key={plant.id} className="data-table-row cursor-pointer">
